 ...
 * @param {string|null} [params.siteUrl] - Service website URL
 * @param {string|null} [params.logoUrl] - Remote favicon URL
 * @param {string|null} [params.logoPath] - Cached local favicon path
